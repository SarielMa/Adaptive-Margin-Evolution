...
def get_loss_function2(z_size, reduction='sum'):
    if len(z_size) <=1:
        ...
        return torch.nn.CrossEntropyLoss(reduction=reduction)
#%%  
def AME_exploration(model, X, Y, margin, norm_type, max_iter, step,
             rand_init_norm=None, rand_init_Xn=None,
...
#%%
def AME_loss(model, X, Y, margin, norm_type, max_iter, step,
             rand_init_norm=None, rand_init_Xn=None,
             clip_X_min=0, clip_X_max=1,
             refine_Xn_max_iter=10,
             Xn1_equal_X=False,
    ...
    if enable_loss3 == True:
        ...
        # to be consistant with the output of AME_loss in RobustDNN_AME
...
#%%
def AME_loss_grad_weighted(model, X, Y, margin, norm_type, max_iter, step,
             rand_init_norm=None, rand_init_Xn=None,
             clip_X_min=0, clip_X_max=1,
             refine_Xn_max_iter=10,
             Xn1_equal_X=False,
...
#%%
def AME_loss_grad2(model, X, Y, margin, norm_type, max_iter, step,
             rand_init_norm=None, rand_init_Xn=None,
             clip_X_min=0, clip_X_max=1,
             refine_Xn_max_iter=10,
             Xn1_equal_X=False,
    ...
    if enable_loss3 and idx_n.size(0)>0:
        ...
        grads_n = torch.zeros(X.size(0), dtype=torch.float32, device=X.device)
    return loss, loss1, loss2, loss3, Yp, advc, Xn, Ypn, idx_n, grads_n


def AME_loss_grad(model, X, Y, margin, norm_type, max_iter, step,
             rand_init_norm=None, rand_init_Xn=None,
             clip_X_min=0, clip_X_max=1,
             refine_Xn_max_iter=10,
             Xn1_equal_X=False,
...
#%%
def AME_loss_grad_faster(model, X, Y, margin, norm_type, max_iter, step,
             rand_init_norm=None, rand_init_Xn=None,
             clip_X_min=0, clip_X_max=1,
             refine_Xn_max_iter=10,
             Xn1_equal_X=False,
    ...
    return loss, loss1, loss2, loss3, Yp, advc, Xn, Ypn, idx_n, grads_n
#%%
def AME_loss_noBinary(model, X, Y, margin, norm_type, max_iter, step,
             rand_init_norm=None, rand_init_Xn=None,
             clip_X_min=0, clip_X_max=1,
             refine_Xn_max_iter=10,
             Xn1_equal_X=False,
...
#%%
def AME_check_margin(model, device, dataloader,
...
#%%
def AME_check_margin_f(model, device, dataloader,
                     margin, norm_type, max_iter, step, rand_init_norm=None,
                     clip_X_min=0, clip_X_max=1,
                     refine_Xn_max_iter=10,
                     Xn1_equal_X=False,
    ...
    return margin_new
#%%
def AME_update_margin(margin, delta, max_margin, flag1, flag2, margin_new):
    # margin: to be updated
    # delta: margin expansion step size
    # max_margin: maximum margin
    # flag1, flag2, margin_new: from AME_check_margin
...
#%%
def AME_update_margin2(margin, delta, max_margin, flag1, flag2, margin_new, delta_decay = None):
    # margin: to be updated
    # delta: margin expansion step size
    # max_margin: maximum margin
    # flag1, flag2, margin_new: from AME_check_margin
    ...
    margin.clamp_(min=0, max=max_margin)
#%%
def AME_update_margin_no_upperbound(margin, delta, flag1, flag2, margin_new, delta_decay = None):
    # margin: to be updated
    # delta: margin expansion step size
    # max_margin: maximum margin
    # flag1, flag2, margin_new: from AME_check_margin
...
#%%
def AME_update_margin_no_upperbound_r(margin, delta, flag1, flag2, margin_new, delta_decay = None):
    # margin: to be updated
    # delta: margin expansion step size
    # max_margin: maximum margin
    # flag1, flag2, margin_new: from AME_check_margin
    ...
    #margin.clamp_(min=0, max=max_margin)
#%%
def AME_update_margin_no_upperbound2(margin, delta, flag1, flag2, margin_new, delta_decay = None):
    # margin: to be updated
    # delta: margin expansion step size
    # max_margin: maximum margin
    # flag1, flag2, margin_new: from AME_check_margin
    ...
    #margin.clamp_(min=0, max=max_margin)
#%%
def AME_estimate_margin(model, device, dataloader,
    ...
    for n in range(1, len(margin_level)):
        ...
        flag1, flag2, Enew =AME_check_margin(model, device, dataloader,
